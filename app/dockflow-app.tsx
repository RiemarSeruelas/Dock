...
export default function DockFlowApp() {
  ...
  const respondToSds = async (shipment: Shipment, payload: SupplierResponsePayload) => {
    ...
    await refresh();
    notify(result.partial ? `Truck confirmed. ${result.remainingMaterialCount} material code${result.remainingMaterialCount === 1 ? "" : "s"} still need a truck.` : "Delivery confirmed. The QR code and report entry are ready.");
  };
